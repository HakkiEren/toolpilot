...
var define_IMAGES_IMAGE_SIZES_default = [16, 32, 48, 64, 96, 128];
...
var define_IMAGES_REMOTE_PATTERNS_default = [{ protocol: "https", hostname: "^(?:^(?:logo\\.clearbit\\.com)$)$", pathname: "^(?:(?!(?:^|\\/)\\.{1,2}(?:\\/|$))(?:(?:(?!(?:^|\\/)\\.{1,2}(?:\\/|$)).)*?)\\/?)$" }, { protocol: "https", hostname: "^(?:^(?:www\\.google\\.com)$)$", pathname: "^(?:\\/s2\\/favicons[^/]*?\\/?)$" }];
