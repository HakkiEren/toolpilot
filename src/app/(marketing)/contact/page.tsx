...
export default function ContactPage() {
  return (
    <article className="max-w-3xl mx-auto px-4 py-12">
      <h1 className="text-3xl md:text-4xl font-extrabold mb-4"><span className="gradient-text">Contact Us</span></h1>
      <p className="text-lg text-gray-600 dark:text-gray-300 mb-10">
        Have a question, found an error, or want to suggest a tool? We would love to hear from you.
      </p>

      <div className="grid md:grid-cols-2 gap-8 mb-12">
        <div className="p-6 rounded-xl border border-gray-200 dark:border-gray-700 hover-lift">
