...
export default async function GlossaryTermPage({ params }: PageProps) {
  ...
  const relatedCalcs = getCalculatorsForCategory(term.categorySlug);
  ...
  return (
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-12">
        ...
        {/* Related Calculators — cross-link to interactive tools */}
            ...
            <div className="grid sm:grid-cols-2 gap-3">
              {relatedCalcs.map((calc) => (
                <Link
                  ...
                  className="group flex items-center gap-3 p-4 bg-gradient-to-r from-indigo-50/80 to-purple-50/80 dark:from-indigo-950/20 dark:to-purple-950/20 rounded-xl border border-indigo-200/50 dark:border-indigo-800/50 hover:border-indigo-300 dark:hover:border-indigo-600 transition-all hover:shadow-md"
                >
                  ...
                  <div>
                    ...
                    <p className="text-[11px] text-gray-500 dark:text-gray-400">Free interactive calculator</p>
                  </div>
                </Link>
              ))}
            </div>
