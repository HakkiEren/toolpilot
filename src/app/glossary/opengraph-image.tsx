...
export const alt = 'ProPicked Glossary';
  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        <div style={{ position: 'absolute', bottom: '-120px', left: '-60px', width: '400px', height: '400px', borderRadius: '50%', background: 'radial-gradient(circle, rgba(6,182,212,0.1) 0%, transparent 70%)', display: 'flex' }} />
        ...
        <div style={{
          ...
          SaaS, AI, E-commerce & Marketing terms explained simply
        </div>
